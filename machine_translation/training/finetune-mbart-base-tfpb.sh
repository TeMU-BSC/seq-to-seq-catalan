#!/bin/bash
    ...
    --task translation_from_pretrained_bart --langs ca,en \
    --criterion label_smoothed_cross_entropy --prepend-bos \
    --arch mbart_base --label-smoothing 0.1 --dataset-impl lazy \
    ...
    --restore-file checkpoints_mbart_ca_en/checkpoint_best.pt
    --save-dir checkpoints_mbart_ca_en_mt \
