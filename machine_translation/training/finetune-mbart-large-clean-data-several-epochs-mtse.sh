...
source ~/.bashrc
    ...
    # Fairseq parameters
    DATA_DIR=data-bin/parallel-data-clean-stage-2
    ...
    UPDATE_FREQ=128         # Total batch size UPDATE_FREQ * MAX_SENTENCES * NUM_GPUS = 2048 x
    ...
    --save-dir checkpoints/mbart_large_ca_en_ft_mtse_clean \
    --restore-file checkpoints/mbart_large_ca_en_ft_mtse_dirty/checkpoint_last.pt \
